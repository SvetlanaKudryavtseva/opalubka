...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"COMMENTS_COUNT" => "5",
		"COMPATIBLE_MODE" => "Y",
		"COMPONENT_TEMPLATE" => "main_seonik",
		...
		"SEF_FOLDER" => "/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => array("sections"=>"catalog/","section"=>"catalog/#SECTION_CODE_PATH#/","element"=>"product/#ELEMENT_CODE#/","compare"=>"compare.php?action=#ACTION_CODE#","smart_filter"=>"catalog/#SECTION_CODE_PATH#/filter/#SMART_FILTER_PATH#/apply/",),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "Y",
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FILTER_NAME" => "array($arSelectedIDs)",
